...
// Genearar un objeto con la búsqueda 
...
year.addEventListener('change', e => {
    datosBusqueda.year = parseInt(e.target.value);  // convertir a entero el numero 
    filtrarAuto();
...
for(let i = max; i>=min; i--){
   ...
   year.appendChild(opcion); // agrega las opciones al año select
...
function noResultado(){
    ...
    noResultado.appendChild(document.createTextNode('No hay Resultados, Intente con otros términos de búsqueda'));
